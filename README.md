...
- **Instant Communication:** Built-in Chat so employers and workers can talk directly without middle-men.
- **FCM Notifications:** Real-time alerts so no one misses a job opportunity.
- **Admin Control:** A secure dashboard to verify users and keep the platform safe.

### How it's built:
I used **Kotlin** for a smooth Android experience and **Firebase** to handle everything from user authentication to real-time database and cloud messaging.
